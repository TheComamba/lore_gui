...
use super::{RelationshipView, RelationshipViewMessage, RelationshipViewState};

impl<'a> RelationshipView<'a> {
    pub(crate) fn new(state: &'a RelationshipViewState) -> Element<'_, GuiMes> {
        Column::new()
    ...
    fn buttons(state: &'a RelationshipViewState) -> Row<'_, GuiMes> {
    ...
    fn col_views(state: &'a RelationshipViewState) -> Row<'_, GuiMes> {
        Row::new()
